...
extension Theme {
  ...
  /// Table | ![](DocCTable)
  public static let blackDocC = Theme()
    .text {
...
extension Color {
  fileprivate static let text = Color(
    light: Color(rgba: 0xf5f5_f7ff), dark: Color(rgba: 0x1d1d_1fff)
  )
  fileprivate static let secondaryLabel = Color(
    light: Color(rgba: 0x8686_8bff), dark: Color(rgba: 0x6e6e_73ff)
  )
  fileprivate static let link = Color(
    light: Color(rgba: 0x2997_ffff), dark: Color(rgba: 0x0066_ccff)
  )
  fileprivate static let asideNoteBackground = Color(
    light: Color(rgba: 0x3232_32ff), dark: Color(rgba: 0xf5f5_f7ff)
  )
  fileprivate static let asideNoteBorder = Color(
    light: Color(rgba: 0x9a9a_9eff), dark: Color(rgba: 0x6969_69ff)
  )
  fileprivate static let codeBackground = Color(
    light: Color(rgba: 0x3333_36ff), dark: Color(rgba: 0xf5f5_f7ff)
  )
  fileprivate static let grid = Color(
    light: Color(rgba: 0x4242_45ff), dark: Color(rgba: 0xd2d2_d7ff)
  )
}
